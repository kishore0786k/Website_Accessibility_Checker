# Website Accessibility Checker Dashboard

A modern React-based accessibility auditing tool that helps developers identify, understand, and fix common web accessibility issues. The application analyzes HTML content, calculates an accessibility score, categorizes issues by severity, and provides educational guidance for improving website usability and compliance.
